...
const Register = () => {
    ...
    return (
        <div className='bg-gradient-to-b from-[#4169e1] to-indigo-100 h-full flex items-center justify-center'>
            <div className='box-content w-fit p-14 bg-[#4169e1] bg-opacity-60 rounded-3xl shadow-slate-900 shadow-2xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 my-32'>
                {/* Avatar Icon */}
