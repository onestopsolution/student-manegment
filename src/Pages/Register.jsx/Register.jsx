...
const Register = () => {
    ...
    return (
        <div className='min-h-screen min-w-full bg-gradient-to-b from-[#4169e1] to-indigo-100 flex items-center justify-center'>
            <div className='h-fit w-96 px-1 py-10 bg-[#4169e1] bg-opacity-60 rounded-3xl shadow-slate-900 shadow-2xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300 mt-40 mb-10'>
                {/* Avatar Icon */}
