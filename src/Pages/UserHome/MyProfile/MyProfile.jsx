...
const MyProfile = () => {
    ...
    return (
        <div className='flex mt-8 lg:mt-0 flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20 min-h-screen w-11/12 my-5 ml-4 lg:ml-14 rounded-3xl'>
            <div data-aos="fade-right" data-aos-duration="3000" className='w-fit h-96 bg-gradient-to-b from-[#8EC5FC] to-[#E0C3FC] p-10 rounded-xl flex flex-col items-center border-y-4 border-black'>
                <img src={userData ? userData.Image : 'https://i.ibb.co/X58Dht9/businesswoman-standing-thinking-near-big-question-mark-isolated-white-background.jpg'} className="w-52 h-96 rounded-xl shadow-lg shadow-black" />
            </div>
            ...
            <div data-aos="fade-left" data-aos-duration="3000" className='w-4/5 mt-5 lg:mt-0'>
