...
const MyProfile = () => {
    ...
    return (
        <div className='flex mt-10 lg:mt-0 flex-col lg:flex-row items-center justify-around gap-20 min-h-screen w-11/12 my-5 ml-4 lg:ml-14 rounded-3xl'>
            <div data-aos="fade-right" data-aos-duration="3000" className='w-fit md:w-96 bg-gradient-to-b from-[#8EC5FC] to-[#E0C3FC] px-10 py-10 rounded-xl flex flex-col items-center border-y-4 border-black'>
            ...
            <div data-aos="fade-left" data-aos-duration="3000" className='w-4/5'>
                ...
                <div data-aos="fade-down" data-aos-duration="3000" className='mt-5 bg-gradient-to-t from-[#B5FFFC] to-[#FFDEE9] px-10 py-10 flex flex-col gap-5 text-xl mx-10 rounded-2xl border-x-4 border-black'>
