    ...
    return (
        <div className='max-w-full mx-5 mt-5 flex flex-col items-center justify-center'>
            <div className="uppercase font-bold bg-gradient-to-r from-[#B721FF] to-[#21D4FD] mb-5 py-3 rounded-full border-black border-b-4 w-full">
                <h3 className="text-3xl text-center text-white">Edit Profile</h3>
            </div>
            <div className="flex justify-center items-center w-full">
                <div className="w-11/12 text-black py-8 bg-gradient-to-r from-indigo-200 to-purple-200 bg-opacity-40 rounded-2xl px-10">
                    <form onSubmit={handleSubmit(onSubmit)} className='w-full flex flex-col items-center justify-center'>
                        ...
                        <div className='flex flex-col lg:flex-row gap-1 lg:gap-5 w-11/12 glass p-5 rounded-2xl mb-5'>
                            <div className="form-control w-full mb-5 flex flex-row gap-2 items-center justify-center">
                                <label className="label ">
                                    <span className="label-text text-xl font-semibold text-black">Birthday :</span>
                                </label>
                                <input
                                    className="input input-bordered bg-slate-800 text-white border-0 w-4/5"
                        ...
                        <div className='flex flex-col lg:flex-row gap-1 lg:gap-5 w-11/12 glass p-5 rounded-2xl mb-5'>
                            ...
                            <div className="form-control w-full mb-5 flex flex-row items-center justify-center">
                                <label className="label-text text-lg lg:text-xl font-semibold text-black">WhatsApp Number:</label>
                        ...
                        <div className='flex flex-col lg:flex-row gap-1 lg:gap-5 w-11/12 glass p-5 rounded-2xl mb-5'>
                            <div className="form-control w-full mb-5 flex flex-row items-center justify-center">
                                <label className="label-text text-lg lg:text-xl font-semibold text-black">Father's Name:</label>
                                <input
                                    className="input input-bordered bg-slate-800 text-white border-0 w-4/5 "
                            ...
                            <div className="form-control w-full mb-5 flex flex-row items-center justify-center">
                                <label className="label-text text-lg lg:text-xl font-semibold text-black">Father's Number:</label>
                                <input
                                    type="tel" // Use type="tel" for phone numbers
                                    className="input input-bordered bg-slate-800 text-white border-0 w-4/5 "
                        ...
                        <div className='flex flex-col lg:flex-row gap-1 lg:gap-5 w-11/12 glass p-5 rounded-2xl mb-5'>
                            <div className="form-control w-full mb-5 flex flex-row items-center justify-center">
                                <label className="label-text text-lg lg:text-xl font-semibold text-black">Mother's Name:</label>
                                <input
                                    className="input input-bordered bg-slate-800 text-white border-0 w-4/5 "
                            ...
                            <div className="form-control w-full mb-5 flex flex-row  items-center justify-center">
                                <label className="label-text text-lg lg:text-xl font-semibold text-black">Mother's Number:</label>
                                <input
                                    type="tel" // Use type="tel" for phone numbers
                                    className="input input-bordered bg-slate-800 text-white border-0 w-4/5 "
