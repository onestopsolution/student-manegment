...
const NoticeBoard = () => {
    return (
        <div className='mt-8 mb-8 lg:mb-0 flex flex-col items-center'>
            <div data-aos="flip-up" className='bg-gradient-to-r from-indigo-200 to-blue-700 py-1 rounded-xl border-b-4 border-black w-full'>
            ...
            <div data-aos="fade-down" data-aos-duration="3000" className="h-fit w-fit py-5 bg-gradient-to-r from-indigo-100 to-blue-200 hover:bg-gradient-to-r hover:from-cyan-200 hover:to-blue-300 rounded-xl">
