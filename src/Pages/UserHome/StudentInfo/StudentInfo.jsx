    ...
    return (
        <div className="hero h-fit w-fit bg-indigo-100 mx-auto mt-10 rounded-2xl py-5 px-20">
            <div className="hero-content flex-col lg:flex-row gap-20 justify-between">
                ...
                <div>
                    <div className='bg-yellow-50 p-8 rounded-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-125 duration-300 shadow-inner shadow-indigo-500'>
