...
const Sidebar = () => {
    ...
    const sideBarItems = <>
        ...
        <li><Link className='flex items-center gap-3 hover:bg-indigo-500 hover:text-white px-5 py-2 rounded-lg'> <SiGoogleclassroom className='h-8 w-8' /> <span className='text-xl font-medium'>Classes</span></Link></li>
    </>
    ...
    return (
        <div  data-aos="fade-right" data-aos-duration="3000" className='max-h-screen w-fit bg-indigo-100 px-5 py-10 lg:py-5 rounded-xl text-start mb-5 lg:mb-8'>
            ...
            <hr className='h-3 bg-gradient-to-r from-indigo-300 to-purple-300 mt-8 w-full rounded-full' />
            {/* <div className='mt-5'>
